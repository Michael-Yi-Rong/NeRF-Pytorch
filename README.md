...
```
git clone https://github.com/Michael-Yi-Rong/NeRF-Pytorch.git
cd nerf-pytorch
...
Shoot a video  
Use ffmpeg & COLMAP to make your dataset and put into `./data/nerf_llff_data/colmap_test`
